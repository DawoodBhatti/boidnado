...
# ---------------------------------------------------------
var test_compute            : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/test_compute.glsl")
var grid_assign             : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_assign.glsl")
var grid_clear              : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_clear.glsl")
var grid_sort_histogram     : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_sort_histogram.glsl")
var grid_sort_prefix        : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_sort_prefix.glsl")
var grid_sort_scatter       : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_sort_scatter.glsl")
var grid_mapping            : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/grid_mapping.glsl")
var behaviour               : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/behaviour.glsl")
var density_3D              : Resource      = load("res://example_10/boids/GPU_simulation_core/GPU_passes/density_3D.glsl")
