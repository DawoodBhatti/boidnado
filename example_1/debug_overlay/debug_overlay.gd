...
@onready var mesh: MeshInstance3D = $"../MeshObject"
...
func _ready() -> void:
	...
	Vertices = $VboxContainer/Vertices

	# Compute vertex count once
	vertex_count = mesh.num_rows * mesh.num_cols
	Vertices.text = "Vertices: %d" % vertex_count
...
func _update_stats() -> void:
	...
	logger.log_results(FPS, CPU, RAM, Draws, vertex_count)
